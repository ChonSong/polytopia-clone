...
- Name: gameplay.spec.ts >> Human-like Gameplay (every interaction through canvas) >> select Xin-xi tribe through the card UI
- Location: tests-e2e/gameplay.spec.ts:87:3
